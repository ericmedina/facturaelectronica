      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="col-md-8 col-xs-12 form-item">
            <label class="col-xs-4 label-control" for="buscar_producto">Producto:</label>
          ...
          <div class="col-md-4 col-xs-12  form-item">
            <label class="col-xs-4 label-control" for="precio_producto">Precio:</label>
            <div class=" col-xs-8 input-group">
              <span class="input-group-addon">$</span>
              <input type="text" name="precio_producto" class="form-control" id="precio_producto" value="0">
            </div>
          </div>
          <div class="col-md-4 col-xs-12  form-item">
        ...
        <div id="card" class=" table-modal">
          <table id="tabla_productos" name="tabla_productos" class="table table-striped table-bordered dt-responsive nowrap hidden" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>Codigo</th>
                  <th>Detalle</th>
