<div class="modal fade modal-agregar-producto" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-lg m-0">
    <div class="modal-content">
      ...
      <div class="modal-body row p-botones">
        <div class="col-md-8 col-md-offset-2 col-xs-12">
          <div class="col-md-12 col-xs-12 form-item">
            <label class="col-xs-3 col-md-3 label-control" for="buscar_producto">Producto:</label>
          ...
          <div class="col-md-6 col-xs-6 form-item">
            <label class="col-xs-6 col-md-4 label-control" for="cantidad_detalle">Cantidad:</label>
            <div class=" col-xs-6 col-md-8 input-group">
