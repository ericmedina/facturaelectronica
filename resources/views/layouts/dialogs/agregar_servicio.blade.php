      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="col-md-8 col-xs-12 form-item">
            <label class="col-xs-4 label-control" for="buscar_servicio">Servicio:</label>
          ...
          <div class="col-md-4 col-xs-12 form-item">
            <label class="col-xs-6 label-control" for="cantidad_servicio">Cantidad:</label>
            <div class=" col-xs-6 input-group">
              <input type="text" name="cantidad_servicio" class="form-control" id="cantidad_servicio" value="1">
            </div>
          </div>
          <div class="col-md-4 col-xs-12  form-item">
            <label class="col-xs-4 label-control" for="precio_servicio">IVA:</label>
            <div class=" col-xs-8 input-group">
          ...
          <div class="col-md-4 col-xs-12  form-item">
            <label class="col-xs-4 label-control" for="precio_servicio">Precio:</label>
            <div class=" col-xs-8 input-group">
              <span class="input-group-addon">$</span>
              <input type="text" name="precio_servicio" class="form-control" id="precio_servicio" value="0">
            </div>
          </div>
          <div class="col-md-4 col-xs-12  form-item">
            <label class="col-xs-4 label-control" for="total_servicio">Total:</label>
            <div class=" col-xs-8 input-group">
              <span class="input-group-addon">$</span>
        ...
        <div id="card" class=" table-modal">
          <table id="tabla_servicios" class="table table-striped table-bordered dt-responsive nowrap hidden" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>Servicio</th>
                  <th>IVA</th>
